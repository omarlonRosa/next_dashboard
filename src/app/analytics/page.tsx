...
const Page = async () => {
    ...
    const pageviews = await analytics.retrieveDays("pageviews", TRACKING_DAYS)
    ...
    const avgVisistorsPerDay = (totalPageviews / TRACKING_DAYS).toFixed(1)
    ...
    return (
        ...
        <div className="relative w-full max-w-6xl mx-auto text-white">
            <AnalyticsDashboard
                avgVisistorsPerDay={avgVisistorsPerDay}
